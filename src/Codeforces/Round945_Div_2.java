...
public class Round945_Div_2 
{
	...
	private static void aHelper(int p1, int p2, int p3)
	{
		if ((p1 + p2 + p3) % 2 != 0) {
            // If the total points are odd or the highest score is more than the sum of the other two scores, it's impossible
